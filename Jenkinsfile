    ...
    stage('RunTest') {
      parallel {
        stage('RunTest') {
          steps {
            echo 'Run test here'
            bat 'newman run UserTest.postman_collection.json -r cli,htmlextra --reporter-htmlextra-export .\\NewmanReports\\index-newmanreport-20200227160000.html'
          }
        }
      ...
      steps {
        script{
          publishHTML (target: [
            ...
            reportFiles: 'index-newmanreport-20200227160000.html',
